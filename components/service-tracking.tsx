    ...
    <div className="flex flex-col h-full max-w-3xl mx-auto">
      <div className="mb-4">
        <div className="flex justify-between items-center">
          <h2 className="text-lg font-medium">Seguimiento de Servicio</h2>
          <Badge className="bg-[#F28C38]">En progreso</Badge>
        </div>
        <p className="text-sm text-gray-500">El técnico está en camino</p>
      </div>
      ...
      <div className="mt-auto pt-4 max-w-xs mx-auto w-full">
        <Link href="/evaluation" className="w-full">
          <Button className="w-full bg-[#F28C38] hover:bg-[#e67d29]">
