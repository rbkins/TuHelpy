...
export default function ServiceConfirmation() {
  return (
    <div className="space-y-6">
      <div className="mb-4">
        <h2 className="text-2xl font-bold">Confirmar Servicio</h2>
        <p className="text-gray-500">Revisa los detalles y realiza el pago</p>
      </div>
      ...
      <div className="flex justify-center pt-4">
        <Link href="/client/service-tracking">
          <Button className="bg-[#F28C38] hover:bg-[#e67d29]">Confirmar y Pagar</Button>
        </Link>
      </div>
    </div>
  )
