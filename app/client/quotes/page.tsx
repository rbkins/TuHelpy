...
export default function Quotes() {
  return (
    <div className="space-y-6">
      <div className="mb-4">
        <h2 className="text-2xl font-bold">Presupuestos disponibles</h2>
        <p className="text-gray-500">Selecciona el técnico que prefieras</p>
      </div>
          ...
          <CardContent className="p-4">
            <div className="flex items-start">
              ...
              <div className="flex-1">
                ...
                <Link href="/client/service-confirmation" className="w-full">
