  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-2xl font-bold">Oportunidades de Servicio</h2>
        ...
        <TabsContent value="available" className="space-y-4 mt-4">
          <Card>
            <CardContent className="p-4">
              ...
              <Link href="/technician/quote-confirmation">
                <Button className="w-full bg-[#4A4A4A] hover:bg-gray-600">Enviar Presupuesto</Button>
              </Link>
            </CardContent>
          </Card>
