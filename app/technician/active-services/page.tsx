...
export default function ActiveServices() {
  return (
    <div className="space-y-6">
      <div className="mb-4">
        <h2 className="text-2xl font-bold">Servicios Activos</h2>
        <p className="text-gray-500">Gestiona tus servicios en curso</p>
      </div>
              ...
              <div className="flex items-start">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex space-x-2 mt-3">
                    ...
                    <Link href="/technician/chat" className="flex-1">
                  ...
                  <Link href="/technician/tech-evaluation">
                    <Button className="w-full mt-2 bg-[#4A4A4A] hover:bg-gray-600">
